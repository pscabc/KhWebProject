...
/**
 * Servlet implementation class IntroTouristServlet
 */
@WebServlet(name = "IntroTourist", urlPatterns = { "/introTourist" })
public class IntroTouristServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public IntroTouristServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        touristMap.put("chkbabycarriage",jo.has("chkbabycarriage")?jo.get("chkbabycarriage").getAsString():"");
        touristMap.put("chkcreditcard",jo.has("chkcreditcard")?jo.get("chkcreditcard").getAsString():"");
        touristMap.put("chkpet",jo.has("chkpet")?jo.get("chkpet").getAsString():"");
        touristMap.put("expguide",jo.has("expguide")?jo.get("expguide").getAsString():"");
        touristMap.put("infocenter",jo.has("infocenter")?jo.get("infocenter").getAsString():"");
        touristMap.put("parking",jo.has("parking")?jo.get("parking").getAsString():"");
        touristMap.put("restdate",jo.has("restdate")?jo.get("restdate").getAsString():"");
        touristMap.put("useseason",jo.has("useseason")?jo.get("useseason").getAsString():"");
        touristMap.put("usetime",jo.has("usetime")?jo.get("usetime").getAsString():"");
...
//        urlBuilder2.append("&" + URLEncoder.encode("contentTypeId","UTF-8") + "=" + typeId);
        ...
        System.out.println("chkpet : "+touristMap.get("chkpet"));
