...
/**
 * Servlet implementation class IntroResServlet
 */
@WebServlet(name = "IntroRes", urlPatterns = { "/introRes" })
public class IntroResServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public IntroResServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("IntroResServlet 시작");
        ...
        touristMap.put("chkcreditcardfood",jo.has("chkcreditcardfood")?jo.get("chkcreditcardfood").getAsString():"");
        touristMap.put("firstmenu",jo.has("firstmenu")?jo.get("firstmenu").getAsString():"");
//        touristMap.put("infocenterfood",jo.get("infocenterfood").getAsString());
        touristMap.put("infocenterfood",jo.has("infocenterfood")?jo.get("infocenterfood").getAsString():"");
//        touristMap.put("kidsfacility",jo.get("kidsfacility").getAsString());
        touristMap.put("kidsfacility",jo.has("kidsfacility")?jo.get("kidsfacility").getAsString():"");
//        touristMap.put("opentimefood",jo.get("opentimefood").getAsString());
        touristMap.put("opentimefood",jo.has("opentimefood")?jo.get("opentimefood").getAsString():"");
        //touristMap.put("parkingfood",jo.get("parkingfood").getAsString());
        touristMap.put("parkingfood",jo.has("parkingfood")?jo.get("parkingfood").getAsString():"");
        //touristMap.put("reservationfood",jo.get("reservationfood").getAsString());
//        touristMap.put("restdatefood",jo.get("restdatefood").getAsString());
        touristMap.put("restdatefood",jo.has("restdatefood")?jo.get("restdatefood").getAsString():"");
//        touristMap.put("smoking",jo.get("smoking").getAsString());
        touristMap.put("smoking",jo.has("smoking")?jo.get("smoking").getAsString():"");
//        touristMap.put("treatmenu",jo.get("treatmenu").getAsString());
        touristMap.put("treatmenu",jo.has("treatmenu")?jo.get("treatmenu").getAsString():"");
...
//        urlBuilder2.append("&" + URLEncoder.encode("contentTypeId","UTF-8") + "=" + typeId);
        ...
        //touristMap.put("homepage", detail6.getAsJsonObject().get("homepage").getAsString());
        JsonObject jo2 = detail6.getAsJsonObject();
        
        System.out.println("IntroResServlet - addr1 : " + jo2.get("addr1").getAsString());
        
        touristMap.put("mapx", jo2.has("mapx") ? jo2.get("mapx").getAsString() : "");
        touristMap.put("addr1", jo2.has("addr1") ? jo2.get("addr1").getAsString() : "");
//        touristMap.put("mapy", jo2.get("mapy").getAsString());
        touristMap.put("mapy",jo2.has("mapy")?jo2.get("mapy").getAsString():"");
//        touristMap.put("overview", jo2.get("overview").getAsString());
        touristMap.put("overview",jo2.has("overview")?jo2.get("overview").getAsString():"");
//        touristMap.put("zipcode", jo2.get("zipcode").getAsString());
...
//        	nearMap.put("addr1",jo3.get("addr1").getAsString());
        	nearMap.put("addr1", jo3.has("addr1") ? jo3.get("addr1").getAsString() : "");
//        	nearMap.put("contenttypeid",jo3.get("contenttypeid").getAsString());
        	nearMap.put("contenttypeid", jo3.has("contenttypeid") ? jo3.get("contenttypeid").getAsString() : "");
//        	nearMap.put("contentid",jo3.get("contentid").getAsString());
        	nearMap.put("contentid", jo3.has("contentid") ? jo3.get("contentid").getAsString() : "");
//        	nearMap.put("title",jo3.get("title").getAsString());
        	nearMap.put("title", jo3.has("title") ? jo3.get("title").getAsString() : "");
        	//nearMap.put("firstimage",detail9.get(i).getAsJsonObject().get("firstimage").getAsString());
