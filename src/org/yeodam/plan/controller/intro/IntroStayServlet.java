...
/**
 * Servlet implementation class IntroStayServlet
 */
@WebServlet(name = "IntroStay", urlPatterns = { "/introStay" })
public class IntroStayServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public IntroStayServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        touristMap.put("barbecue",jo.has("barbecue")?jo.get("barbecue").getAsString():"");
        touristMap.put("beverage",jo.has("beverage")?jo.get("beverage").getAsString():"");
        touristMap.put("campfire",jo.has("campfire")?jo.get("campfire").getAsString():"");
        touristMap.put("checkintime",jo.has("checkintime")?jo.get("checkintime").getAsString():"");
        touristMap.put("checkouttime",jo.has("checkouttime")?jo.get("checkouttime").getAsString():"");
        touristMap.put("chkcooking",jo.has("chkcooking")?jo.get("chkcooking").getAsString():"");
        touristMap.put("fitness",jo.has("fitness")?jo.get("fitness").getAsString():"");
        touristMap.put("infocenterlodging",jo.has("infocenterlodging")?jo.get("infocenterlodging").getAsString():"");
        touristMap.put("karaoke",jo.has("karaoke")?jo.get("karaoke").getAsString():"");
        touristMap.put("parkinglodging",jo.has("parkinglodging")?jo.get("parkinglodging").getAsString():"");
        touristMap.put("publicbath",jo.has("publicbath")?jo.get("publicbath").getAsString():"");
        touristMap.put("publicpc",jo.has("publicpc")?jo.get("publicpc").getAsString():"");
        touristMap.put("reservationlodging",jo.has("reservationlodging")?jo.get("reservationlodging").getAsString():"");
        touristMap.put("roomcount",jo.has("roomcount")?jo.get("roomcount").getAsString():"");
        touristMap.put("roomtype",jo.has("roomtype")?jo.get("roomtype").getAsString():"");
        touristMap.put("sauna",jo.has("sauna")?jo.get("sauna").getAsString():"");
        touristMap.put("sports",jo.has("sports")?jo.get("sports").getAsString():"");
