...
/**
 * Servlet implementation class SearchTourListServlet
 */
@WebServlet(name = "SearchTourList", urlPatterns = { "/searchTourList" })
public class SearchTourListServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SearchTourListServlet() {
        super();
